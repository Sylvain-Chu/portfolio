          ...
          <Slide delay={0.1}>
            ...
            {profile?.resumeURL && profile.resumeURL !== "#" && (
              <a
                ...
                className="inline-flex items-center gap-2 mt-4 px-5 py-2.5 rounded-lg bg-primary-color text-zinc-900 font-medium text-sm hover:opacity-90 transition-opacity"
              >
                Télécharger mon CV
              </a>
            )}
